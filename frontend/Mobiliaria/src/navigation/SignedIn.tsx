        ...
        <>
            ...
            >
                <Stack.Group>
                    ...
                    />
                    <Stack.Screen options={{ title: 'Clientes', headerShown: true, header: (props) => <BasicHeader hideBackArrow color='#00bcbb' title='Home' backgroundColor='white' /> }} name='Clients' component={Clients} />
