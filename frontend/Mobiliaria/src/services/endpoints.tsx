...
export const ADD_DIRECTIONS_EVENT_PATH = API_EVENTS + '/ubication'
...
export const GET_EXPENSES = API_EXPENSES + '/getExpenses'
export const ADD_EXPENSE = API_EXPENSES + '/addExpense'
export const ADD_RECURRING_EXPENSE = API_EXPENSES + '/addRecurringExpense'
export const EDIT_EXPENSE = API_EXPENSES + '/editExpense'
export const REMOVE_EXPENSE = API_EXPENSES + '/removeExpense'

export const GET_REPORTS = API_REPORTS + '/getReports'
export const GET_FINANCIAL_SUMMARY = API_REPORTS + '/getFinancialSummary'
