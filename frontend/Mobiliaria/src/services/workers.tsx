...
export const getWorkers = async (): Promise<any> => {
    const url = `http://3.218.160.237:8000${GET_WORKERS}`
...
export const getEventsDelivery = async (date: string): Promise<any> => {
    const url = `http://3.218.160.237:8000${GET_WORKERS_EVENTS}?date=${date}`
...
export const addWorker = async (body: any): Promise<any> => {
    const url = `http://3.218.160.237:8000${ADD_WORKER}`
...
export const editWorker = async (body: any): Promise<any> => {
    const url = `http://3.218.160.237:8000${EDIT_WORKER}`
...
export const active = async (active: 0 | 1, id: number): Promise<any> => {
    const url = `http://3.218.160.237:8000${ACTIVE_WORKER}?type=${active}&id=${id}`
...
export const deleteWorker = async (id: number): Promise<any> => {
    const url = `http://3.218.160.237:8000${REMOVE_WORKER}?id=${id}`
